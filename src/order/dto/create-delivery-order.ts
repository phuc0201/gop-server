...
export class CreateDeliveryOrderDto extends CreateOrderDto {
  ...
  @ApiProperty({
    title: 'LONG -> LAT',
    example: new LocationObject(
      [106.77163744626203, 10.849841965343426],
  ...
  @ApiProperty({
    example: [
      new OrderFoodItems('6647a4011216ae8cfd4a9c21', 2, [
        '6647a3ff1216ae8cfd4a9c11',
        '6647a3ff1216ae8cfd4a9c0c',
        '6647a3ff1216ae8cfd4a9c0e',
      ]),
    ],
  })
  @IsNotEmpty()
